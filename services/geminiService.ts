...
export const analyzePrompt = async (
  ...
  6. 极致服饰与材质物理分析:
     ...
     - **长腿特化修改(关键)**：如果图2穿着短裙或短裤，必须在脚本中将其描述为“超短款(Micro-mini)”。**极度强调高腰设计**，腰头位置显著上提，而下摆位置需描述为“刚好在耻骨联合处进行遮挡”，**一切目的都是为了在视觉上最大限度地显腿长**。
  ...
  9. 黄金比例与体态微调:
     ...
     - **超级长腿透视**：在保持原动作的基础上，强制应用“长腿透视矫正”。通过微调透视或延伸感，让肢体线条看起来极度修长。**一切为了显腿长**，消除任何视觉压缩感，使人物比例达到超模级别的腿身比。
